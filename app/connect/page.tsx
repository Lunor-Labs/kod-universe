    ...
    <div className="relative min-h-screen bg-canvas overflow-hidden pt-32 pb-24 text-earth">
      ...
      <div className="container-site relative z-10">
        <div className="text-center mb-14 mt-8">
          ...
          <h1 className="heading-hero font-editorial font-normal text-earth mb-6">
            Let&apos;s Create
            <br />
            Something <em className="italic font-normal">Extraordinary.</em>
          </h1>
          <p className="text-lead text-kod-earth/85 max-w-xl mx-auto">
            Whether you have a bold idea, a complex challenge,
            <br className="hidden md:block" />
            or just want to explore possibilities-our team is here to help.
            <br />
            <strong className="font-bold text-earth block mt-3 text-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-4 p-2 md:p-6 flex flex-col justify-between gap-8">
              <div>
                ...
                <ul className="space-y-4 text-base text-kod-earth/85 pl-11">
                  <li className="flex items-center gap-3">
                    <Mail size={16} className="text-kod-earth/60" />
                    <a
                      href={`mailto:${siteConfig.contact.email}`}
                      className="hover:text-signal-orange transition-colors font-medium"
                    >
                      {siteConfig.contact.email}
                    </a>
                  </li>
                  <li className="flex items-center gap-3">
                    <Phone size={16} className="text-kod-earth/60" />
                    <div className="flex flex-col gap-1">
                      {siteConfig.contact.phones.map((phone) => (
                        ...
                        >
                          {phone.number}
                          <span className="text-kod-earth/60 ml-2">({phone.region})</span>
                        </a>
                      ))}
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <MapPin size={16} className="mt-0.5 text-kod-earth/60" />
              ...
              <div>
                ...
                <div className="pl-11">
                  <p className="text-kod-earth/85 text-base leading-relaxed mb-3">
                  ...
                  <a
                    href={`mailto:${siteConfig.contact.email}`}
                    className="text-base font-bold text-signal-orange hover:text-earth transition-colors"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              ...
              {services.slice(0, 4).map((service, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="heading-item text-earth mb-2 line-clamp-1 uppercase tracking-wider">
                      {service.title}
                    </h3>
                    <p className="text-body text-kod-earth/80 line-clamp-3">
                      {service.description}
                    </p>
                  </div>
                );
            ...
            <div className="md:col-span-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-base text-kod-earth/85 leading-relaxed mb-3">
                  {siteConfig.name}
                  <br />
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-sm font-bold text-signal-orange hover:text-earth transition-colors"
                >
                  View on Map
