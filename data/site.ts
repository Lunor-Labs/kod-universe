...
export const siteConfig: SiteConfig = {
  name: "KOD Universe",
  tagline:
    "A 360° creative agency shaping brands through design, marketing and visual storytelling.",
  description:
  ...
  socialLinks: [
    ...
    {
      platform: "Behance",
      href: "https://www.behance.net/koduniverse",
      iconName: "Behance",
    },
    {
      platform: "Facebook",
  ...
  contact: {
    email: "hello@kod.lk",
    phones: [{ region: "Sri Lanka Hub", number: "077 200 0504" }],
    locations: ["Colombo 07, Sri Lanka"],
  },
};
