...
const WHATSAPP_NUMBER = "947720000504";
  ...
  return (
    ...
    >
      <button
        ...
        className={`w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white hover:bg-kod-canvas text-earth hover:text-signal-orange border border-border-warm/80 shadow-md hover:shadow-xl flex items-center justify-center transition-all duration-300 group cursor-pointer ${
          showTopButton
      ...
      <a
        ...
        aria-label="Chat on WhatsApp with KOD Universe"
      ...
      >
        ...
        <div className="relative w-12 h-12 sm:w-13 sm:h-13 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-lg hover:shadow-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-105 active:scale-95">
          <svg
