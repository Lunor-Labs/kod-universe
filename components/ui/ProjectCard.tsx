...
export function ProjectCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group block bg-white border border-border-warm rounded-sm overflow-hidden",
    ...
    >
      {/* Image */}
      <div className={cn("img-zoom relative", size === "large" ? "aspect-[4/3]" : "aspect-project-card")}>
        <Image
      ...
      {/* Details */}
      <div className="p-4">
        <p className="eyebrow text-[10px] mb-1.5 text-secondary">
          {project.category}
        </p>
        <h3 className="font-metropolis font-semibold text-earth text-base leading-snug mb-1 
